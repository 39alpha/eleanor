    ...
    try:
        ...
        if position == 'd':
            ...
            while not re.findall(r'^\*------------------', p_lines[x]):
                ...
                # fluid, without exhaustion this is a default standin. note that other codes may
                # alter this later, such as when some limited amount of seawater entrainment is
                # accounted for.
