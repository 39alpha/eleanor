...
class TestSignals(TestCase):
    ...
    def test_shutdown_on_signal_installs_and_restores_handlers(self) -> None:
    ...
    def test_shutdown_on_signal_handler_raises_keyboard_interrupt(self) -> None:
    ...
    def test_safe_prev_returns_sig_dfl_for_none(self) -> None:
