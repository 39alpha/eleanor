...
def load_navigator_settings(kind: str, raw: dict[str, object]) -> NavigatorSettings:
    return load_plugin_settings(registry, NavigatorSettings, kind, raw) or NavigatorSettings()


def load_navigator(kind: str, settings: NavigatorSettings | None = None) -> AbstractNavigator:
