...
class TestStatementProfilerLifecycle(TestCase):
    ...
    def test_cannot_be_entered_twice(self) -> None:
        """
    ...
    def test_only_one_active_profiler_at_a_time(self) -> None:
        """
    ...
    def test_exit_restores_connection_module_connect(self) -> None:
        """
...
class TestStatementProfilerCounters(TestCase):
    ...
    def test_records_single_row_insert_by_table(self) -> None:
        """
    ...
    def test_records_executemany_row_count_from_params_seq(self) -> None:
        """
    ...
    def test_reconciles_rowcount_against_parameter_estimate(self) -> None:
        """
    ...
    def test_records_copy_statement_as_bulk_write(self) -> None:
        """
    ...
    def test_buckets_non_insert_statements(self) -> None:
        """
...
class TestStatementProfilerConnectionRetrofit(TestCase):
    ...
    def test_existing_connections_get_factory_swapped(self) -> None:
        """
...
class TestToText(TestCase):
    ...
    def test_renders_sql_objects_via_as_string(self) -> None:
    ...
    def test_falls_back_to_str_for_unknown_query_shapes(self) -> None:
...
class TestStatementProfilerWiringEdges(TestCase):
    ...
    def test_wrapped_connect_raises_when_real_connect_was_not_captured(self) -> None:
        """
    ...
    def test_report_renders_other_statements_section_with_recorded_kinds(self) -> None:
        """
...
class TestProfilingCursorPassthrough(TestCase):
    ...
    def test_execute_passes_through_when_no_active_profiler(self) -> None:
    ...
    def test_executemany_passes_through_when_no_active_profiler(self) -> None:
    ...
    def test_copy_passes_through_when_no_active_profiler(self) -> None:
