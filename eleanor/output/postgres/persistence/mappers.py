    ...
    return models.VSPointModel(
        ...
        special_reactants=[
            models.VSSpecialReactantModel(
                ...
                composition=[
                    models.VSSpecialReactantCompositionModel(element=c.element, count=c.count)
...
def to_es_point_model(point: core_es.Point) -> models.ESPointModel:
    return models.ESPointModel(
        ...
        elements=[models.ESElementModel(name=e.name, log_molality=e.log_molality, mass_fraction=e.mass_fraction)
...
def from_vs_point_model(model: models.VSPointModel) -> core_vs.Point:
    return core_vs.Point(
        ...
        special_reactants=[core_vs.SpecialReactant(
            ...
            log_moles=r.log_moles,
            titration_rate=r.titration_rate,
            composition=[core_vs.SpecialReactantComposition(element=c.element, count=c.count) for c in r.composition],
        ...
        solid_solution_reactants=[core_vs.SolidSolutionReactant(
            ...
            log_moles=r.log_moles,
            titration_rate=r.titration_rate,
            end_members=[core_vs.SolidSolutionReactantEndMembers(name=em.name, fraction=em.fraction)
                         for em in r.end_members],
...
def from_es_point_model(model: models.ESPointModel) -> core_es.Point:
    return core_es.Point(
        ...
        elements=[core_es.Element(name=e.name, log_molality=e.log_molality, mass_fraction=e.mass_fraction)
