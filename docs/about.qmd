...
Eleanor requires the version of [EQ3/6 hosted by 39
Alpha](https://github.com/39alpha/eq3_6), which has been slightly modified to
...
- [EQ3/6](https://github.com/39alpha/eq3_6>)
...
1. Eleanor does not allow you to set basis species to homogeneous or
   heterogeneous equilibrium (except for $f_{O2}$).
