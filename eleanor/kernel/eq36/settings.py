...
class Eq6Settings:
    ...
    ttk1: np.float64 = field(default_factory=lambda: np.float64(0))
    ttk2: np.float64 = field(default_factory=lambda: np.float64(0))
    xi_min: np.float64 = field(default_factory=lambda: np.float64(0))
    xi_max: np.float64 = field(default_factory=lambda: np.float64(100))
    time_min: np.float64 = field(default_factory=lambda: np.float64(0))
    time_max: np.float64 = field(default_factory=lambda: np.float64(1e38))
    ph_min: np.float64 = field(default_factory=lambda: np.float64(-1e38))
    ...
    log_xi_print_interval: np.float64 = field(default_factory=lambda: np.float64(1e38))
    time_print_interval: np.float64 = field(default_factory=lambda: np.float64(1e38))
