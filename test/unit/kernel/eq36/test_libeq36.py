...
class TestEq36Libeq36(TestCase):
    ...
    @staticmethod
    def _successful_header_side_effect(*args) -> None:
        for i, value in [
            (1, 1),  # ikta_asv
            (2, 1),  # ipbt_asv
            (3, 1),  # ipch_asv
    ...
    def test_get_libpath_linux_and_darwin(self) -> None:
        """
    ...
    def test_read_data1_open_failure_closes_file(self) -> None:
        """
        Ensure read_data1 surfaces open errno failures and still closes the native handle.
        """

        def open_side_effect(_fname, data1_ptr, errno_ptr, _flen) -> None:
    ...
    def test_read_data1_wraps_open_exception_without_close(self) -> None:
        """
    ...
    def test_read_data1_wraps_open_oserror_without_close(self) -> None:
        """
    ...
    def test_read_data1_header_failure_closes_file(self) -> None:
        """
        Ensure header errno failures are raised and cleanup uses the opened handle.
        """

        def open_side_effect(_fname, data1_ptr, _errno_ptr, _flen) -> None:
            data1_ptr._obj.value = 11

        def header_side_effect(*args) -> None:
            args[-1]._obj.value = 3
    ...
    def test_read_data1_success_path_returns_expected_structure(self) -> None:
        """
    ...
    def test_read_data1_wraps_header_exception_and_closes_file(self) -> None:
        """
    ...
    def test_read_data1_wraps_body_exception_and_closes_file(self) -> None:
        """
    ...
    def test_read_data1_non_ascii_filename_raises_encode_error(self) -> None:
        """
    ...
    def test_read_data1_raises_when_errno_set_by_read_body(self) -> None:
        """
