...
class TestEq36Exec(TestCase):
    ...
    def test_error_guard_no_error_text(self):
        """
    ...
    def test_error_guard_raises_with_and_without_fname(self):
        """
    ...
    def test_run_nonzero_returncode_raises(self):
        """
    ...
    def test_run_timeout_without_errors(self):
        """
    ...
    def test_run_timeout_with_errors(self):
        """
        Ensure timeout with parsed subprocess errors raises wrapped timeout-with-errors exception.
        """
        process = SimpleNamespace(
            communicate=mock.Mock(side_effect=[TimeoutExpired(cmd="eq6", timeout=1), (b"Error - fail", b"")]),
            returncode=0,
            kill=mock.Mock(),
        )
        with (
    ...
    def test_wrapper_functions_call_run(self):
        """
