...
from eleanor.cli.registry import available_cli_commands, get_factory, register_cli_command, registry
from eleanor.exceptions import EleanorException
from eleanor.plugin import OverrideWarning, SimplePluginSpec


@pytest.mark.usefixtures("clean_registry")
def test_register_and_retrieve(spec: SimplePluginSpec):
    name = "plugin"
...
@pytest.mark.usefixtures("clean_registry")
def test_register_rejects_bool_api_version(spec: SimplePluginSpec):
...
@pytest.mark.usefixtures("clean_registry")
def test_register_rejects_too_new_api_version(spec: SimplePluginSpec):
    name = "too_new"
...
@pytest.mark.usefixtures("clean_registry")
def test_register_can_override_max_plugin_version(mocker: MockerFixture, spec: SimplePluginSpec):
...
@pytest.mark.usefixtures("clean_registry")
def test_register_rejects_builtin_name(spec: SimplePluginSpec):
    name = "postgres"
