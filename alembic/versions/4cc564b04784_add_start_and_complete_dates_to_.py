...
def upgrade() -> None:
    if not column_exists('variable_space', 'start_date'):
        op.add_column('variable_space', sa.Column('start_date', sa.DateTime, server_default='1970-01-01T12:00:00'))
    if not column_exists('variable_space', 'complete_date'):
        op.add_column('variable_space', sa.Column('complete_date', sa.DateTime, server_default='1970-01-01T12:00:00'))
