...
class TestEq36Kernel(TestCase):
    ...
    def test_write_eq6_input_writes_all_reactant_blocks_for_valid_typed_reactants(self):
        ...
        mineral = MineralReactant(name="Calcite", log_moles=0.0, titration_rate=1.0, id=None, variable_space_id=None)
        ...
        element = ElementReactant(name="Na", log_moles=0.0, titration_rate=1.0, id=None, variable_space_id=None)
