...
the YAML/TOML/JSON file) and the version of **Eleanor** used to execute the
order.
...
```sql
SELECT id, name, eleanor_version, create_date FROM orders;

+----+----------------------+-----------------+------------------------+
| id | name                 | eleanor_version | create_date            |
|----+----------------------+-----------------+------------------------|
| 1  | A Wild Example Order | 0.19.0          | 2026-01-09 10:59:01.98 |
+----+----------------------+-----------------+------------------------+
```
