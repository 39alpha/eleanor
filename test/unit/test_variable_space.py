...
class TestVariableSpace(TestCase):
    ...
    def _make_point(self, species=None, reactant_sizes=None):
        ...
        mineral = [MineralReactant(name=f"m{i}", log_moles=0.0, titration_rate=1.0, id=None)
                   for i in range(reactant_sizes[0])]
        aqueous = [AqueousReactant(name=f"a{i}", log_moles=0.0, titration_rate=1.0, id=None)
                   for i in range(reactant_sizes[1])]
        gas = [GasReactant(name=f"g{i}", log_moles=0.0, titration_rate=1.0, id=None)
               for i in range(reactant_sizes[2])]
        element = [ElementReactant(name=f"e{i}", log_moles=0.0, titration_rate=1.0, id=None)
        ...
        fixed_gas = [
            FixedGasReactant(name=f"fg{i}", log_moles=0.0, log_fugacity=0.0, id=None)
