...
class TestCoercion(TestCase):
    ...
    def test_parse_missing_policy_accepts_all_supported_values(self):
        """
    ...
    def test_parse_missing_policy_rejects_unknown_value(self):
        """
    ...
    def test_coerce_filter_value_for_primitives(self):
        """
    ...
    def test_coerce_filter_value_for_enum_by_name_and_value(self):
        """
        Ensure enum filters accept both member names and member values.
        """
        self.assertIs(coerce_filter_value(_Kind, "LOW", path="p", predicate="k=LOW"), _Kind.LOW)
        self.assertIs(coerce_filter_value(_Kind, "high", path="p", predicate="k=high"), _Kind.HIGH)

    def test_coerce_filter_value_rejects_invalid_values(self):
        """
