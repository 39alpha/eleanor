...
from eleanor.query.aliases import (
...
class TestAliases(TestCase):
    ...
    def test_singularize_handles_common_plural_forms(self) -> None:
        """
    ...
    def test_singularize_irregular_forms_match_compound_suffixes(self) -> None:
        """
    ...
    def test_aliases_for_returns_short_form_when_defined(self) -> None:
        """
    ...
    def test_validate_short_forms_current_table_is_consistent(self) -> None:
        """
        Ensure short-form alias registry passes its internal consistency checks.
        """
        validate_short_forms()

    def test_validate_short_forms_static_rejects_duplicate_values(self) -> None:
        """
    ...
    def test_validate_short_forms_static_rejects_short_form_default_collision(
        self,
    ) -> None:
        """
